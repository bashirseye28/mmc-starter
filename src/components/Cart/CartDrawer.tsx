...
const CartDrawer: FC<CartDrawerProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Drawer */}
      <div
        className={`fixed top-0 right-0 bottom-0 w-full md:w-[420px] lg:w-[460px] bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out flex flex-col
      ...
      >
        ...
        {cart.length > 0 && (
          <div className="px-5 py-3 border-t text-sm text-gray-600 bg-white">
            <p>
              <span className="font-medium text-primary">Note:</span> Delivery or
              pickup will be selected at checkout.
            </p>
          </div>
        )}
